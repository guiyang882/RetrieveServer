...
public:
    ...
    ::RPCImgRecong::WordRes fetchImgSearchResult(const ::RPCImgRecong::DictStr2Str& mapArg)
    {
        return fetchImgSearchResult(mapArg, 0);
    }
    ::RPCImgRecong::WordRes fetchImgSearchResult(const ::RPCImgRecong::DictStr2Str& mapArg, const ::Ice::Context& __ctx)
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_fetchImgSearchResult(const ::RPCImgRecong::DictStr2Str& mapArg, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::RPCImgRecong::WordRes&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
...
public:
    ...
    ::RPCImgRecong::WordRes imgSearchSync(const ::RPCImgRecong::DictStr2Str& mapArg)
    {
        return imgSearchSync(mapArg, 0);
    }
    ::RPCImgRecong::WordRes imgSearchSync(const ::RPCImgRecong::DictStr2Str& mapArg, const ::Ice::Context& __ctx)
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_imgSearchSync(const ::RPCImgRecong::DictStr2Str& mapArg, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::RPCImgRecong::WordRes&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
...
public:
    ...
    virtual ::RPCImgRecong::WordRes fetchImgSearchResult(const ::RPCImgRecong::DictStr2Str&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;

    virtual ::RPCImgRecong::WordRes imgSearchSync(const ::RPCImgRecong::DictStr2Str&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::RPCImgRecong::WordRes fetchImgSearchResult(const ::RPCImgRecong::DictStr2Str&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);

    virtual ::RPCImgRecong::WordRes imgSearchSync(const ::RPCImgRecong::DictStr2Str&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
